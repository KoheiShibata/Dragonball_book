    ...
    <div class="form-body">
        ...
        <form action="/create" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group">
                <label class="register-label" for="name">☆キャラクター名</label><br>
            ...
            <div class="form-group">
                <label class="register-label" for="content">☆キャラクター説明</label><br>
            ...
            <label for="tribe" class="register-label">カテゴリー</label>
            ...
            <label for="season" class="register-label">シーズン</label>
            ...
            <label for="attack" class="register-label">攻撃</label>
            <select name="attack" class="chart" id="attack" required>
                <option value="">選択してください</option>
                @for ($i=1;$i<=10;$i++) <option value="{{$i}}">{{$i}}</option>
                    @endfor
            </select>
            <label for="defence" class="register-label">守備</label>
            <select name="defence" class="chart" id="defence" required>
                <option value="">選択してください</option>
                @for ($i=1;$i<=10;$i++) <option value="{{$i}}">{{$i}}</option>
                    @endfor
            </select>
            <label for="ability" class="register-label">潜在能力</label>
            <select name="ability" class="chart" id="ability" required>
                <option value="">選択してください</option>
                @for ($i=1;$i<=10;$i++) <option value="{{$i}}">{{$i}}</option>
                    @endfor
            </select>
            <label for="popularity" class="register-label">人気度</label>
    ...
    <script>
        ...
        function addEvent(id) {
            ...
            preview.addEventListener("change", (e) => {
                ...
                const previewImage = createPreviwImage(id, blob)
        ...
        function getChildrenMaxId() {
            ...
            return previewAreaLastElement.querySelector('img') ? Number(previewAreaLastElement.querySelector('img').id.replace('previewImage_', '')) : initId
        }

        function createPreviwImage(id, blob) {
